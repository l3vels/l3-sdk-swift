...
public struct PlayerAsset: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String, amount: Double, playerId: String, assetId: String, collectionId: String, accountId: String, gameId: String, createdOn: Date, modifiedOn: Date, createdBy: String, modifiedBy: String) {
        self.id = id
        self.amount = amount
