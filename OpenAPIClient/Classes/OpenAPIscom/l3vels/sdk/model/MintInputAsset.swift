...
@available(*, deprecated, renamed: "OpenAPIClientAPI.MintInputAsset")
public typealias MintInputAsset = OpenAPIClientAPI.MintInputAsset

extension OpenAPIClientAPI {

/** Asset to mint. You need to provide token ID or asset ID and amount to mint */
public struct MintInputAsset: Codable, JSONEncodable, Hashable {
