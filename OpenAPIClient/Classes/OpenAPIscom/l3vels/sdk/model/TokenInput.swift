...
@available(*, deprecated, renamed: "OpenAPIClientAPI.TokenInput")
public typealias TokenInput = OpenAPIClientAPI.TokenInput

extension OpenAPIClientAPI {

public struct TokenInput: Codable, JSONEncodable, Hashable {
